...
Segment colSegment0 = { SIZE(colSec0), colSec0, true }; //numSections, section array pointer, direction

segmentSection colSec1[] = {{5, 7}}; //col 1, 7 pixels, facing reverse direction from col 1
Segment colSegment1 = { SIZE(colSec1), colSec1, false }; //numSections, section array pointer, direction

segmentSection colSec2[] = {{12, 7}}; //col 2, 7 pixels
Segment colSegment2 = { SIZE(colSec2), colSec2, true }; //numSections, section array pointer

segmentSection colSec3[] = {{19, 9}}; //col 3, 9 pixels, facing reverse direction from col 1
Segment colSegment3 = { SIZE(colSec3), colSec3, false }; //numSections, section array pointer

segmentSection colSec4[] = {{28, 11}}; //col 4, 11 pixels
Segment colSegment4 = { SIZE(colSec4), colSec4, true }; //numSections, section array pointer

segmentSection colSec5[] = {{39, 13}}; //col 5, 13 pixels, facing reverse direction from col 1
Segment colSegment5 = { SIZE(colSec5), colSec5, false }; //numSections, section array pointer

segmentSection colSec6[] = {{52, 13}}; //col 6, 13 pixels
Segment colSegment6 = { SIZE(colSec6), colSec6, true }; //numSections, section array pointer

segmentSection colSec7[] = {{65, 11}}; //col 7, 11 pixels, facing reverse direction from col 1
Segment colSegment7 = { SIZE(colSec7), colSec7, false }; //numSections, section array pointer

segmentSection colSec8[] = {{76, 9}}; //col 8, 9 pixels
Segment colSegment8 = { SIZE(colSec8), colSec8, true }; //numSections, section array pointer

segmentSection colSec9[] = {{85, 7}}; //col 9, 7 pixels, facing reverse direction from col 1
Segment colSegment9 = { SIZE(colSec9), colSec9, false }; //numSections, section array pointer

segmentSection colSec10[] = {{92, 7}}; //col 8, 7 pixels
Segment colSegment10 = { SIZE(colSec10), colSec10, true }; //numSections, section array pointer

segmentSection colSec11[] = {{99, 5}}; //col 11, 5 pixels, facing reverse direction from col 1
Segment colSegment11 = { SIZE(colSec11), colSec11, false }; //numSections, section array pointer
...
Segment colHalfSegment0 = { SIZE(colHalfSec0), colHalfSec0, false }; //numSections, section array pointer, direction
...
Segment colHalfFlipSegment0 = { SIZE(colHalfFlipSec0), colHalfFlipSec0, true }; //numSections, section array pointer, direction
...
Segment colCenSegment0 = { SIZE(colCenSec0), colCenSec0, true }; //numSections, section array pointer, direction

segmentSection colCenSec1[] = {{5, 7}}; //col 1, facing reverse direction from col 1
Segment colCenSegment1 = { SIZE(colCenSec1), colCenSec1, false }; //numSections, section array pointer, direction

segmentSection colCenSec2[] = {{12, 7}}; //col 2, 
Segment colCenSegment2 = { SIZE(colCenSec2), colCenSec2, true }; //numSections, section array pointer

segmentSection colCenSec3[] = {{20, 7}}; //col 3, facing reverse direction from col 1
Segment colCenSegment3 = { SIZE(colCenSec3), colCenSec3, false }; //numSections, section array pointer

segmentSection colCenSec4[] = {{30, 7}}; //col 4,
Segment colCenSegment4 = { SIZE(colCenSec4), colCenSec4, true }; //numSections, section array pointer

segmentSection colCenSec5[] = {{42, 7}}; //col 5, facing reverse direction from col 1
Segment colCenSegment5 = { SIZE(colCenSec5), colCenSec5, false }; //numSections, section array pointer

segmentSection colCenSec6[] = {{55, 7}}; //col 6, 
Segment colCenSegment6 = { SIZE(colCenSec6), colCenSec6, true }; //numSections, section array pointer

segmentSection colCenSec7[] = {{67, 7}}; //col 7, facing reverse direction from col 1
Segment colCenSegment7 = { SIZE(colCenSec7), colCenSec7, false }; //numSections, section array pointer

segmentSection colCenSec8[] = {{77, 7}}; //col 8,
Segment colCenSegment8 = { SIZE(colCenSec8), colCenSec8, true }; //numSections, section array pointer

segmentSection colCenSec9[] = {{85, 7}}; //col 9, 7 pixels, facing reverse direction from col 1
Segment colCenSegment9 = { SIZE(colCenSec9), colCenSec9, false }; //numSections, section array pointer

segmentSection colCenSec10[] = {{92, 7}}; //col 8, 7 pixels
Segment colCenSegment10 = { SIZE(colCenSec10), colCenSec10, true }; //numSections, section array pointer

segmentSection colCenSec11[] = { {-1,1}, {99, 5}, {-1,1}}; //col 11, 5 pixels, facing reverse direction from col 1
Segment colCenSegment11 = { SIZE(colCenSec11), colCenSec11, false }; //numSections, section array pointer
...
segmentSection rowSec0[] = {{-1, 1}, {5, 1}, {18, 1}, {19, 1}, {38, 1}, {39, 1}, {64, 1}, {65, 1}, {84, 1}, {85, 1}, {98, 1}, {-1, 1} };
Segment rowSegment0 = { SIZE(rowSec0), rowSec0, true }; //numSections, section array pointer, direction

segmentSection rowSec1[] = {{-1, 1}, {5, 1}, {18, 1}, {19, 1}, {37, 1}, {40, 1}, {63, 1}, {66, 1}, {84, 1}, {85, 1}, {98, 1}, {-1, 1} };
Segment rowSegment1 = { SIZE(rowSec1), rowSec1, true }; //numSections, section array pointer, direction

segmentSection rowSec2[] = {{-1, 1}, {5, 1}, {18, 1}, {20, 1}, {37, 1}, {41, 1}, {62, 1}, {66, 1}, {83, 1}, {85, 1}, {98, 1}, {-1, 1} };
Segment rowSegment2 = { SIZE(rowSec2), rowSec2, true }; //numSections, section array pointer, direction

segmentSection rowSec3[] = {{-1, 1}, {5, 1}, {18, 1}, {20, 1}, {36, 1}, {42, 1}, {61, 1}, {67, 1}, {83, 1}, {85, 1}, {98, 1}, {-1, 1} };
Segment rowSegment3 = { SIZE(rowSec3), rowSec3, true }; //numSections, section array pointer, direction

segmentSection rowSec4[] = {{4, 1}, {6, 1}, {17, 1}, {21, 1}, {35, 1}, {43, 1}, {60, 1}, {68, 1}, {82, 1}, {86, 1}, {97, 1}, {99, 1} };
Segment rowSegment4 = { SIZE(rowSec4), rowSec4, true }; //numSections, section array pointer, direction

segmentSection rowSec5[] = {{3, 1}, {7, 1}, {16, 1}, {22, 1}, {34, 1}, {44, 1}, {59, 1}, {69, 1}, {81, 1}, {87, 1}, {96, 1}, {100, 1} };
...
segmentSection rowSec7[] = {{1, 1}, {9, 1}, {14, 1}, {24, 1}, {32, 1}, {46, 1}, {57, 1}, {71, 1}, {79, 1}, {89, 1}, {94, 1}, {102, 1} };
Segment rowSegment7 = { SIZE(rowSec7), rowSec7, true }; //numSections, section array pointer, direction

segmentSection rowSec8[] = {{0, 1}, {10, 1}, {13, 1}, {25, 1}, {31, 1}, {47, 1}, {56, 1}, {72, 1}, {78, 1}, {90, 1}, {93, 1}, {103, 1} };
Segment rowSegment8 = { SIZE(rowSec8), rowSec8, true }; //numSections, section array pointer, direction

segmentSection rowSec9[] = {{-1, 1}, {11, 1}, {12, 1}, {26, 1}, {30, 1}, {48, 1}, {55, 1}, {73, 1}, {77, 1}, {91, 1}, {92, 1}, {-1, 1} };
Segment rowSegment9 = { SIZE(rowSec9), rowSec9, true }; //numSections, section array pointer, direction

segmentSection rowSec10[] = {{-1, 1}, {11, 1}, {12, 1}, {26, 1}, {29, 1}, {49, 1}, {54, 1}, {74, 1}, {77, 1}, {91, 1}, {92, 1}, {-1, 1} };
Segment rowSegment10 = { SIZE(rowSec10), rowSec10, true }; //numSections, section array pointer, direction

segmentSection rowSec11[] = {{-1, 1}, {11, 1}, {12, 1}, {27, 1}, {29, 1}, {50, 1}, {53, 1}, {75, 1}, {76, 1}, {91, 1}, {92, 1}, {-1, 1} };
Segment rowSegment11 = { SIZE(rowSec11), rowSec11, true }; //numSections, section array pointer, direction

segmentSection rowSec12[] = {{-1, 1}, {11, 1}, {12, 1}, {27, 1}, {28, 1}, {51, 1}, {52, 1}, {75, 1}, {76, 1}, {91, 1}, {92, 1}, {-1, 1} };
